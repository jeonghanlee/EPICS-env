...
# MODULESGEN.mk is generated by the first make run in the checkout.
[[ -s "${ENV_CHECKOUT}/configure/MODULESGEN.mk" ]] \
    || die "${ENV_CHECKOUT}/configure/MODULESGEN.mk not found; prepare the checkout first (make <MODULE>, then make conf.release.modules conf.<module>)"
