...
| T5 | Not run | Owner-confirmed vendor installation | Pending | Record the helper source commit, binary digest, linked-library paths, and the no-device exit status after the build |
