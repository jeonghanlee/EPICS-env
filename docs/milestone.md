...
-> its implementation, twelve p0 patches on the M22 carry discipline, is
now the next code-closable entry point ahead of the M7 release gate;
M23 (#51) stays post-release. Backlog
...
| M27 Docs modernization | Reorganize `docs/`, modernize content, publish as an mdBook site on GitHub Pages (#54) | Milestone | Not started | Added by owner 2026-07-26, in the 1.3.0 release. Current state: Pages is enabled (homepage jeonghanlee.github.io/EPICS-env) but the branch carries no book.toml, no SUMMARY.md, and no deploy workflow; `docs/` mixes user-facing docs, design records, and cycle records; naming defects (e.g. `REAME.EPICSParam.md`). Deliverable: clean doc structure, book.toml + SUMMARY.md, a Pages deploy workflow, modernized user-facing content |
| M27.T1 | `mdbook build` clean; the deploy workflow publishes; the site renders the new structure with valid internal links | Verification | Not started | |
...
Tally: Milestones 28 (Complete 25, Not started 3 — M27 docs/mdBook; the M7 gate; M23 post-release) · Verification subs 37 (Complete 31, Not started 6)
