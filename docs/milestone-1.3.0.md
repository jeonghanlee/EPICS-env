...
(a vendor name spelled three ways and two undocumented commands in
`tools/prep-vendors.bash`), both opened 2026-08-07 from the document review and
both required before the M7 gate begins -> then the M7 release gate.
...
Tally: Milestones 29 (Complete 26, Not started 3 — M30, M31, and the M7 gate) · Verification subs 39 (Complete 32, Not started 7)
